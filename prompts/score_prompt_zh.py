# Pairwise scoring prompt for comparing two articles against merged criteria.
...
# Static scoring prompt with predefined criteria.
...
# Dynamic scoring prompt without a reference article.
...
# Vanilla prompt for direct overall article scoring.
vanilla_prompt = """
<system_role>你是一名严格、细致、客观的调研文章评估专家。你擅长根据具体的评估标准，对调研文章进行深入评估，并给出精确的评分和清晰的理由。</system_role>
